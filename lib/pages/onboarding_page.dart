...
import 'package:yoru_phonics/pages/signup_page.dart';
...
class HomePage extends StatelessWidget {
  ...
  Column _buildOnboardingBottom(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Text(
          "The fun and interactive way to improve your kids reading and writing skills across all languages",
          style: Theme.of(
            context,
