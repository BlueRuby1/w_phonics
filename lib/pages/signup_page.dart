...
import 'package:yoru_phonics/widgets/signup_section.dart';
import 'package:yoru_phonics/widgets/type_of_user_selection_section.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            if (currentPageIndex == 1) TypeOfUserSelectionSection(
              options: ["Guardian", "Teacher", "Tutor", "Other"],
